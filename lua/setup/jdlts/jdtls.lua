...
local function get_bundles()
  ...
  local java_debug_path = vim.fn.expand "$MASON/package/java-debug-adapter"
  ...
  local java_test_path = vim.fn.expand "$MASON/package/java-test"
